...
CARDS = [
  ...
  ("set-06-s1",
   ...
   [
     ...
     "Think of something you're currently stuck on — at work or at home. Now list everything outside yourself that's actually part of that situation: the physical space, the time pressure, who else is involved, what's going on in your body, what happened earlier today.",
     "Look at your list. Ask: if these things shifted — different space, different time, different physical state — would the problem look the same? What part of this is really \"you deciding,\" and what part is just the conditions?",
   ],
